...
function setMode(bStatus){
	...
	if(bStatus){
		...
		if(gIsIE){
			HtmlEditor.style.height = "186px";
			divEditor.style.height = "186px";
		}else{
			HtmlEditor.style.height = "185px";
			divEditor.style.height = "185px";
		}
...
function createLink() {
	var sURL=window.prompt("Enter link location (e.g. http://www.sgemedia.com/):", "http://");
